...
#Model. p<0.05 include that variabl. meaning H0=Variable is correlated.
...
#assumption check
#linearity
#1-Autocorrelation. Product of error terms is always zero.
durbinWatsonTest(LRM) #Close to 2 is good for H0 to true. H0 = Residuals are not correlated
?durbinWatsonTest

#2 - Normality of errors with mean 0
hist(residuals(LRM))

#3 - Homoskedasticity residuals are not showing any pattern. vaiance 0f the error terms is constant. Residuals are along mean horizonal line 
